...
$html = file_get_html('http://192.168.0.187/heliosInverterData');
...
if ($AC_ActivePower && $AC_ReactivePower && $DC_Power) {
    $stmt = $conn->prepare("INSERT INTO helios_left (HeliosLeft_PkW, HeliosLeft_SkVA, HeliosLeft_PdckW) VALUES (?, ?, ?)");
