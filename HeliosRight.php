...
$html = file_get_html('http://192.168.0.188/heliosInverterData');
...
if ($AC_ActivePower && $AC_ReactivePower && $DC_Power) {
    $stmt = $conn->prepare("INSERT INTO helios_right (HeliosRight_PkW, HeliosRight_SkVA, HeliosRight_PdckW) VALUES (?, ?, ?)");
